...
// Fonte: HAGO_STATE_MACHINE_v1.3, seção 4.2 (B1.3)
// S0 = ciclo aberto (IPE em andamento)
// S1 = ciclo encerrado uma vez (IPE concluído, primeiro ciclo completo)
// S2 = múltiplos ciclos consolidados
// S1/S2: definição de CycleState em types.ts (S1 — movido de hago.ts)
export type CycleState = "S0" | "S1" | "S2";
