-- Migration: scoring_block_prompts v0.4.2
-- Date: 2026-03-28
-- Description: 4-layer null reduction system
--   Camada 1: Regra Cardinal — INDETERMINADO proibido quando resposta presente
--   Camada 2: Pill fallback reforçado — nunca null quando pill tem dado
--   Camada 3: Re-ask flagging — reask_recomendado quando scoring incompleto
--   Camada 4: Inferência dimensional — no questionnaire-engine (não neste SQL)
-- Predecessor: v0.4.1

-- ============================================================
-- Migration: Insert 16 scoring block prompts into prompt_versions
-- Fonte: DESIGN_ENGINE_SCORING_BLOCK v1.0, §6.2 (E2)
-- Changelog v0.4.1 → v0.4.2: 4 camadas anti-null (Regra Cardinal, Pill fallback, Re-ask, Inferência)
-- Version: v0.4.2
...
-- NOTA: Esta versão insere v0.4.2 como INACTIVE (rollback de segurança)
-- Não toca no v0.4.5 que está em produção

-- Desativar todas as versões anteriores de scoring_block_* antes de inserir v0.4.2
