-- ============================================================
-- MIGRATION 07 — Prompt eco_PI v2.c.2 (Reed v1 — Eu ↔ Pertencimento)
-- Wave 9: replica arquitetura v2.c.2 da PVI nas demais 5 Pills.
-- ============================================================
...
WHERE component = 'eco_PI' AND version != 'v2.c.2' AND active = true;
...
═══ ESPECÍFICO PI (Eu ↔ Pertencimento) ═══
...
-- VALIDAÇÃO:
-- SELECT component, version, active FROM prompt_versions WHERE component = 'eco_PI' ORDER BY created_at DESC;
