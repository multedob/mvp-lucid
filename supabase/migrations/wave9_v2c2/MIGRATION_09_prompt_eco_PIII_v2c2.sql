-- ============================================================
-- MIGRATION 09 — Prompt eco_PIII v2.c.2 (Reed v1 — Presença ↔ Distância)
-- ============================================================
...
WHERE component = 'eco_PIII' AND version != 'v2.c.2' AND active = true;
...
═══ ESPECÍFICO PIII (Presença ↔ Distância) ═══
