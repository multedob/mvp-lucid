...
-- Change 1: Add hago_state column to cycles
ALTER TABLE cycles ADD COLUMN hago_state VARCHAR NOT NULL DEFAULT 'H0';

-- Change 2: Recreate lucid_persist_cycle with p_hago_state parameter
