...
-- Desativar todas as versões anteriores de scoring_block_* antes de inserir v0.4.0
...
INDETERMINADO: resposta insuficiente para decidir.
...
INDETERMINADO: resposta insuficiente.
...
INDETERMINADO: não há dado que permita decidir.
...
INDETERMINADO: não há dado de pressão que permita decidir.
...
INDETERMINADO: não há dado de efeito no outro que permita decidir.
